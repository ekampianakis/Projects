...
class my_top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c(self.tx_vector, True, 1, [])
        ...
        self.connect((self.blocks_head_0_0_0, 0), (self.blocks_vector_sink_x_0, 0))
...
if __name__ == '__main__':
    ...
    tx_mat_contents = sio.loadmat(tx_filename)
    tx_vector = (tx_mat_contents['TX_vector'][0])
    ...
    def run_flowgraph(tb):
        ...
        if(TCP):
            ...
            sio.savemat(rx_filename1, {'vector':tb.blocks_vector_sink_x_0.data()})
            sio.savemat(rx_filename2, {'vector':tb.blocks_vector_sink_x_1.data()})
